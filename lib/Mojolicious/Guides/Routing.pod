...
ones.
  ...
  # /cats      -> {controller => 'cats', action => 'index',   foo => 'hi' }
  # /cats/nyan -> {controller => 'cats', action => 'nyan',    foo => 'hi' }
  # /cats/lol  -> {controller => 'cats', action => 'default', foo => 'bye' }
  my $cats = $r->any('/cats')->to(controller => 'cats', action => 'default', foo => 'hi');
  $cats->get('/')->to(action => 'index');
  $cats->get('/nyan')->to(action => 'nyan');
  $cats->get('/lol', foo => 'bye');
